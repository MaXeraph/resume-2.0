  ...
  \experience
    ...
    {May 2020} {
                    \begin{itemize}
                        ...
                        \item Designed a generic \textbf{API scheduler} for all microservices' APIs using \link{https://github.com/kagkarlsson/db-scheduler}{\underline{db-scheduler} } library, increasing marketing outreach by \textbf{28\%}
