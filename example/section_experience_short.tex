  ...
  \experience
    ...
    {Present} {
                    \begin{itemize}
                        ...
                        \item Consolidated 100\% of company-wide documentations to a single Wiki solution: \link{https://js.wiki/}{Wiki.JS}. Deployed the service to AWS ECS with a robust permission/auth structure through OneLogin 
