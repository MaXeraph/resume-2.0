  ...
  \experienceCurrent
    ...
    {July 2022} {
                    \begin{itemize}
                        ...
                        \item Integrated backend system with Smart Contracts of a Blockchain-powered web-app game.

                        \item Reduced cost by 10\% by implementing In-house Mobile Dynamic Messaging System, replacing existing SAAS usage
